---
description: "Orquestrador universal e agnóstico de commits atômicos, documentação inline/externa e governança de Architecture Decision Records (ADRs) em 6 fases determinísticas (Stage -> Validate & ADR Check -> Commit Individual -> Repeat -> Session Tech Doc -> Terminal Final Report).\n"
---
