---
description: "Auditoria e otimização automatizada de SEO tradicional (Google/Bing), AEO (Answer Engine Optimization) e GEO (Generative Engine Optimization) para Perplexity, Gemini, Claude Search e ChatGPT com suporte a llmstxt.org e Schema.org JSON-LD.\n"
---
