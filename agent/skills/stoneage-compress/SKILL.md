---
description: "Comprime arquivos de memória (.md, .txt) em formato stoneage para reduzir tokens de input. Preserva toda substância técnica, código, URLs e estrutura. Versão compacta sobrescreve o original. Backup salvo como FILE.original.md.\n"
---
# Stoneage Compress
