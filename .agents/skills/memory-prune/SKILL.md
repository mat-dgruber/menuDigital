...
name: memory-prune
description: >
  Mantém MEMORY.md limpo e eficiente. Remove entradas obsoletas, consolida duplicatas
  e mantém o índice enxuto para evitar injeção desnecessária de tokens de contexto.
user-invocable: true
triggers:
  - memory prune
  - limpa memory
