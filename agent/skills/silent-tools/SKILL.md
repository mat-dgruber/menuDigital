---
description: "Comprime output de ferramentas (Bash, grep, logs, testes) em resumo de 2-3 linhas no chat. Reduz consumo de tokens ao exibir resultados de ferramentas no histórico.\n"
---
