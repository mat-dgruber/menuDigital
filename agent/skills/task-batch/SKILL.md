---
description: "Agrupa TaskCreate e TaskUpdate em chamadas paralelas no mesmo turno. Menos turnos = menos tokens de overhead em requisições consecutivas. Use quando criar ou completar 2+ tasks.\n"
---
