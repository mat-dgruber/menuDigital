...
name: context-trim
description: >
  Reduz consumo de contexto podando saídas de ferramentas grandes (Bash, Grep, Read, APIs).
  Extrai apenas os dados essenciais e descarta o payload intermediário não utilizado.
user-invocable: true
triggers:
  - context trim
  - cortar contexto
